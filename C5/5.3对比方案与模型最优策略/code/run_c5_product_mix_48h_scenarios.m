...
error('C5:RetiredSynthetic48hComparison', ...
    ['The synthetic 48 h sequence is validation-only and cannot rank ', ...
     'schemes. Use run_c5_all_channel_48h_sequence for model validation ', ...
     'and run_c5_typical48_causal_comparison for baselines plus the 22 ', ...
     'fixed hourly policies.']);
