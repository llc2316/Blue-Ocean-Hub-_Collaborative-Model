...
- 第5章全通道压力场景：`integration/build_all_channel_source_scenario_4_3.m`
...
`build_all_channel_source_scenario_4_3.m`复用4.3正式风/光/潮24小时相对出力形状，
按800 MW（风680/光80/潮40 MW）和6个阶段倍率构造48小时调度压力序列。装机与倍率
均为 **[假设值，待企业调研校准]**，只用于检查全部消纳出口能否按序激活，不作为资源
评估、容量优化或推荐装机结论。
