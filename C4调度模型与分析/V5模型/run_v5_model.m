...
persistent foundationCache foundationCacheRoot
if isempty(foundationCache) || ~strcmp(foundationCacheRoot,root)
    foundationCache=v5_foundation_registry(root);
    foundationCacheRoot=root;
end
