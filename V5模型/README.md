...
> 全部V5验证输出已迁至同级`C5/`。本目录只保留V5物理模型、配置、冻结接口、供能适配、
> 基础证据和求解内核。下文涉及`scenarios/`、`validation/`、`chapter5_preparation/`
> 和`outputs/`的内容仅为迁移前历史说明，活跃入口以`C5/00_C5导航.md`为准。
...
这些材料已迁移到同级`C5/`，其中`C5/5.1场景设计`和`C5/5.3—5.7`是活跃入口，
`C5/迁移自C4_V5`保存迁移前原件用于哈希追溯。
...
somedata/                         4.3公开资源代理及C5年度场景所需本地输入
