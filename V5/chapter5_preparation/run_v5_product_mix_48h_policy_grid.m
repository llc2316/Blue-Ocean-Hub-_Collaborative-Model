function grid = run_v5_product_mix_48h_policy_grid( ...
    caseIds,ensLimitsMWh,utilizationMinimums,outputDir)
%RUN_V5_PRODUCT_MIX_48H_POLICY_GRID Screen ENS/utilization epsilon limits.
%
...
for i=1:numel(ensLimitsMWh)
    for j=1:numel(utilizationMinimums)
        ...
        [records{r},~,~]=run_v5_product_mix_48h_scenarios( ...
            caseIds,"",policy);
    end
end
