...
```csv
equivalent_gpu_it_power_kw,1.275,kW/GPU,DGX H100/H200最大系统功率10.2kW除以8块GPU,NVIDIA官方产品文档_公开代理值
```

当前公开代理采用1.275 kW/GPU，使MW-IT到GPU·h的换算可追溯：
...
```csv
task_type,price_yuan_per_gpu_h,reference_sku
rigid_inference,7.58,H20
flexible_batch,4.98,A800
continuous_training,8.88,H800
optional_job,2.78,RTX5090
```
...
"constant_electricity_price_yuan_per_mwh": 401.34
```

含义是在整个168小时当前市场情景中采用广东2026年6月月度综合价参照401.34元/MWh，以及8.20 MW的DC输入上限。2025年6月372.70元/MWh保留在`market_reference_scenarios.csv`作为历史敏感性情景。代码自动生成168小时向量，不需要手工复制168行。
