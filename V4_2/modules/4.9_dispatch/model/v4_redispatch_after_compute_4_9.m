...
if ~asset_enabled(cfg,'powerExportCable',true), exportLimit=0; end
...
electrolyzerHeadroomMW=max(0,cfg.hydrogen.electrolyzerRatedMW- ...
    baseElectrolyzerMW);
if ~asset_enabled(cfg,'PEMElectrolyzer',true)
    electrolyzerHeadroomMW(:)=0;
    deliveryHeadroomKg(:)=0;
    flowThroughPowerCapMW(:)=0;
end
